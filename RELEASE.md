# Parameter set 3ob:ophyd-1-2

Density Functional Tight Binding (DFTB) parameter set providing modified O-P for 3ob (improves description of pentavalent phosphorus species)
